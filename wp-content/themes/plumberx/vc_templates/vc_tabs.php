...
$tabs_nav = '';
$tabs_nav .= '<ul class="wpb_tabs_nav ui-tabs-nav vc_clearfix clearfix">';
...
if ( 'vc_tour' === $this->shortcode ) {
	$output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous tab', 'plumberx' ) . '">' . __( 'Previous tab', 'plumberx' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next tab', 'plumberx' ) . '">' . __( 'Next tab', 'plumberx' ) . '</a></span></div>';
}
